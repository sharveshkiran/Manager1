...
export default class EditManager extends Component {
    ...
    editManager(e)
    {
        ...
        axios.patch('http://localhost:50735/api/ManagerDetails/UpdateManager/'+managerId,{
        ...
        alert("manager "+managerId+" updated");
    })
    .catch(error=>{
        alert("error");
    })
        ...
        return (
          ...
          <form>
            ...
            <tr >
              ...
              <tr>
                <td><button type="button" onClick={this.editManager}>Manager signup</button> 
                </td>
              </tr>
              </tbody>
            </table>
